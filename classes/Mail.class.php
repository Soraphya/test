<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'contato@soraphya.com';//Trocar e-mail aqui!
		public $senha = 'acerola2901';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'smtp.soraphya.com'; //SERVIDOR SMTP DA HOSPEDAGEM
